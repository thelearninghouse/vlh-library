...
<main id="app" class="content">
  ...
  <transition-group name="company" tag="ul" class="content__list">
    ...
    <li class="degree" v-for="degree in degreeList" :key="degree.id">
      <div class="degree__info">

        <h2 class="degree__name">{{ degree.title.rendered }}</h2>
        <blockquote class="degree__slogan">{{ degree.slug }}</blockquote>
      </div>
      ...
      <ul class="degree__details">
        <li class="degree__data">
          ...
          <div class="degree__country">
            <span v-for="vertical in degree.verticals" class="">
                {{vertical}}
              </span>
          </div>
        </li>
